...
```
Distribution of training set, over-balanced.
```{r}
# As numbers
...
Distribution of training set, under-balanced.
```{r}
# As numbers
...
Distribution of training set, balanced.
```{r}
...
Distribution of training set, SMOTE.
```{r}
